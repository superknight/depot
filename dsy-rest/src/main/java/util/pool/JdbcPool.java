...
public class JdbcPool implements DataSource {
	...
	static {
		...
		// getResourceAsStream("/system_db.properties");
		InputStream in = JdbcPool.class.getClassLoader().getResourceAsStream("system_db.properties");
		Properties prop = new Properties();
		try {
			prop.load(in);
			String driver = prop.getProperty("connection.driverclass");
			String url = prop.getProperty("connection.url");
			String username = prop.getProperty("connection.username");
