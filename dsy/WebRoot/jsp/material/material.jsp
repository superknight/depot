...
<html>
  ...
  <%@include file="/static/public.jsp"%>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/jsp/material/js/material.js"></script>
  </head>
  <body>
   <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 
   <span class="c-gray en">&gt;</span> 素材管理
    <span class="c-gray en">&gt;</span> 素材管理
	...
	<span class="l">
	<a class="btn btn-success radius" onclick="mater_upload('素材上传','mater-upload.html')" href="javascript:;">
	<i class="Hui-iconfont">&#xe600;</i> 素材上传</a>
